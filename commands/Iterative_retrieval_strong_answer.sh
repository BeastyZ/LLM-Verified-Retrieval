...
# python Iterative_retrieval_strong_answer.py \
...
# openai_api=1 
# num_samples=1 
# data_file=iter_retrieval_50_strong-answer/asqa_final_data/final_data_bge-large-en-v1.5_max_iteration-4_prompt12-update-using-missing-info-from-question-and-psgs_head.json
# ndoc=5
...
# output_dir=iter_retrieval_50_strong-answer/${dataset_name}_max-4_bge-large-en-v1.5-prompt12_llm-select-head_run_eval
# mkdir $output_dir -p
...
openai_api=1 
num_samples=1 
data_file=iter_retrieval_50_strong-answer/qampari_final_data/final_data_bge-large-en-v1.5_max_iteration-4_prompt12-update-using-missing-info-from-question-and-psgs_head.json
ndoc=5
openai_multi_thread=10
model=gpt-3.5-turbo-0301
quick_test=0 
