...
openai_api=1 
num_samples=1 
data_file=iter_retrieval_50/asqa_final_data/final_data_bge-large-en-v1.5_max_iteration-4_prompt12-update-using-missing-info-from-question-and-psgs_head.json
ndoc=5
...
openai_api=1 
num_samples=1 
data_file=iter_retrieval_50/asqa_final_data/final_data_bge-large-en-v1.5_max_iteration-4_prompt13-update-using-missing-info-from-question-and-psgs_head.json
ndoc=5
openai_multi_thread=10
model=gpt-3.5-turbo-0301
quick_test=0 
