...
-ndoc_top_bottom${ndoc_top_bottom}-ndoc_top_neighbor${ndoc_top_neighbor}-ndoc_random${ndoc_random}"
...
--ndoc_top_bottom $ndoc_top_bottom \
--ndoc_top_neighbor $ndoc_top_neighbor \
--ndoc_random $ndoc_random
