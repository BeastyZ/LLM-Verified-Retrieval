...
openai_api=1 
num_samples=1 
data_file=iter_retrieval_50_hyde/eli5_final_data/final_data_bm25_max_iteration-4_prompt12-update-using-missing-info-from-question-and-psgs_head.json
ndoc=5
...
output_dir=iter_retrieval_50_hyde/${dataset_name}_max-4_bm25-prompt12_llm-select-head_run_eval
mkdir $output_dir -p
